...
(function ($) {
    ...
    g1.skinSwitcher = function () {
        ...
        $('.g1-drop-the-skin').each( function() {
            ...
            if ( localStorage.getItem('g1_skin') ) {
...
// @todo wesoly
// Move the code to the appropriate place.
(function ($) {

    'use strict';

    var switchNSFW = function( b ) {
        if ( b ) {
            localStorage.setItem('g1_nsfw_off', 1);
            document.documentElement.classList.add('g1-nsfw-off');
        } else {
            localStorage.removeItem('g1_nsfw_off');
            document.documentElement.classList.remove('g1-nsfw-off');
        }
    };

    $(document).ready(function () {
        switchNSFW(localStorage.getItem('g1_nsfw_off'));

        $('.g1-drop-the-nsfw').each( function() {
            var $this = $(this);
            if ( localStorage.getItem('g1_nsfw_off') ) {
